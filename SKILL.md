---
name: brclio-design-system
description: Brclio 的个人IP设计系统。做HTML页面、个人网站、教程页面、介绍页面、landing page等任何前端设计时自动触发。包含品牌DNA和多个场景子规范。
license: CC BY-NC-SA 4.0
metadata:
  author: Brclio
  repo: https://github.com/Brclio/brclio-design-system
---

> © 2026 Brclio | CC BY-NC-SA 4.0
> 使用本 Skill 需署名 Brclio，禁止商用，修改后须以相同协议分享。
...
### Step 2: 读规范
1. **必读** `brand-dna.md` 和 `references/identity.md` — 确认品牌底层规范与 Brclio 的当前身份、头像、签名和链接
2. 根据类型选读场景文件：
